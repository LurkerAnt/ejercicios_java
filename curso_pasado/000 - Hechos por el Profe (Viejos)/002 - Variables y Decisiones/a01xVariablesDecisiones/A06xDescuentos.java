...
public class A06xDescuentos {
	...
	/*
	 * if(precio < 50) System.out.println("precio final: " + precio*1.15); else
	 * if(precio < 100){ System.out.println("precio final: " + (precio*0.95)*1.15);
	 * 
	 * } else System.out.println("precio final: " + (precio*0.90)*1.15); }
	 */
