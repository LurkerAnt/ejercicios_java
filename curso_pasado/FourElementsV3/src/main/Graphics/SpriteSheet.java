...
public class SpriteSheet {
	...
	public static SpriteSheet emibluh = new SpriteSheet("/Textures/spriteSheets/Monsters/PrototypeMonster.png", 128,
			160);
	...
	public static SpriteSheet projectile_aang = new SpriteSheet("/Textures/spriteSheets/Projectiles/airbending.png",
			96);
	public static SpriteSheet airMeleeAtack = new SpriteSheet("/Textures/spriteSheets/Projectiles/airMeleeAtackv2.png",
			64, 32);
	public static SpriteSheet airMeleeAtackUpDown = new SpriteSheet(
			"/Textures/spriteSheets/Projectiles/airMeleeAtackUpDownv2.png", 32, 64);
	public static SpriteSheet earthCrash = new SpriteSheet("/Textures/spriteSheets/Projectiles/EarthCrash.png", 160,
			128);
	...
	public static SpriteSheet characters = new SpriteSheet("/Textures/spriteSheets/CharactersFonts/characters.png", 80,
			8);
	public static SpriteSheet mainTitle = new SpriteSheet("/Textures/spriteSheets/Title/Title.png", 400, 225);
	public static SpriteSheet mainTitleBackGround = new SpriteSheet("/Textures/spriteSheets/Title/background.png", 400,
			225);
	...
	public static SpriteSheet menuBackground = new SpriteSheet("/Textures/spriteSheets/Interface/interface.png", 65,
			225);
	public static SpriteSheet selectedOption = new SpriteSheet("/Textures/spriteSheets/Interface/selectedOption.png",
			44, 16);
	public static SpriteSheet gameOverWindow = new SpriteSheet("/Textures/spriteSheets/Interface/gameOverWindow.png",
			200, 100);
	...
	// Pruebas
	public static SpriteSheet infernoPointer = new SpriteSheet("/Textures/spriteSheets/Projectiles/Inferno/Inferno.png",
			144, 48);
	public static SpriteSheet comet = new SpriteSheet("/Textures/spriteSheets/Projectiles/Inferno/Comet.png", 96, 32);

	// Cenimatica de Zuko
	public static SpriteSheet zukoStageCh = new SpriteSheet("/Textures/spriteSheets/Cinematics/ZukoStageChange.png",
			384, 480);
	public static SpriteSheet zukoCinematic = new SpriteSheet("/Textures/spriteSheets/Cinematics/ZukoCinematic.png", 96,
			32);
	public static SpriteSheet zukoLeaving = new SpriteSheet("/Textures/spriteSheets/Cinematics/ZukoLeaving.png", 128,
			32);
	...
	// Este constructor era para cargar una parte de un Sheet, no lo hago porque no
	// me parece correcto
	// cargar una imagen + partes de su imagen solo para quitar los Sprites creados
	// de la clase Sprite
	/*
	 * public SpriteSheet(SpriteSheet sheet, int x, int y, int width , int height,
	 * int spriteSize) { int xx = x * spriteSize; int yy = y * spriteSize; int w =
	 * width * spriteSize; int h = height * spriteSize; if (width == height) SIZE =
	 * width; else SIZE = -1; WIDTH = w; HEIGHT = h; pixels = new int[w * h]; for
	 * (int y0 = 0; y0 < h; y0++) { int yp = yy + y0; for (int x0 = 0; x0 < w; x0++)
	 * { int xp = xx + y0; pixels[x0 + y0 * w] = sheet.pixels[xp + yp *
	 * sheet.WIDTH]; } } }
	 */
