...
public class Sprite {
	...
	public static Sprite[] beetleHpBar = { new Sprite(32, 2, 0xFFFF0000), new Sprite(30, 2, 0xFFFF0000),
			new Sprite(28, 2, 0xFFFF0000), new Sprite(26, 2, 0xFFFF0000), new Sprite(24, 2, 0xFFFF0000),
			new Sprite(22, 2, 0xFFFF0000), new Sprite(20, 2, 0xFFFF0000), new Sprite(16, 2, 0xFFFF0000),
			new Sprite(16, 2, 0xFFFF0000), new Sprite(14, 2, 0xFFFF0000), new Sprite(12, 2, 0xFFFF0000),
			new Sprite(10, 2, 0xFFFF0000), new Sprite(9, 2, 0xFFFF0000), new Sprite(6, 2, 0xFFFF0000),
			new Sprite(3, 2, 0xFFFF0000) };

	// Emibluh
	public static Sprite[] emibluh = SpriteSheet.getSprites(32, 32, 4, 5, SpriteSheet.emibluh);

	// hp Bar universal
	public static Sprite[] hpBar = { new Sprite(28, 2, 0xFFFF0000), new Sprite(24, 2, 0xFFFF0000),
			new Sprite(20, 2, 0xFFFF0000), new Sprite(16, 2, 0xFFFF0000), new Sprite(12, 2, 0xFFFF0000),
			new Sprite(8, 2, 0xFFFF0000), new Sprite(4, 2, 0xFFFF0000) };
