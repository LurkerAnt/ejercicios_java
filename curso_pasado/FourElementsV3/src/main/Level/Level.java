...
//	}
	...
	public Tile getTile(int x, int y) {
		...
		if (tiles[x + y * width] == Tile.colSpawnGrassA)
			return Tile.spawnGrassA;
		if (tiles[x + y * width] == Tile.colSpawnStonesA)
			return Tile.spawnStonesA;
		if (tiles[x + y * width] == Tile.colSpawnWallA)
			return Tile.spawnWallA;
		if (tiles[x + y * width] == Tile.colSpawnWallB)
			return Tile.spawnWallB;
		if (tiles[x + y * width] == Tile.colSpawnDustA)
			return Tile.spawnDustA;
		if (tiles[x + y * width] == Tile.colRockGrassA)
			return Tile.spawnRockGrassA;
		if (tiles[x + y * width] == Tile.colRockGrassB)
			return Tile.spawnRockGrassB;
		if (tiles[x + y * width] == Tile.colRockSolidA)
			return Tile.spawnRockSolidA;
		if (tiles[x + y * width] == Tile.colRockRoadA)
			return Tile.spawnRockRoadA;
		if (tiles[x + y * width] == Tile.colLavaA)
			return Tile.lavaA;
		if (tiles[x + y * width] == Tile.colMountainTextureA)
			return Tile.mountainTextureA;
		if (tiles[x + y * width] == Tile.colDirtLava)
			return Tile.dirtLava;
		if (tiles[x + y * width] == Tile.colLavaMountainUp)
			return Tile.lavaMountainUp;
		if (tiles[x + y * width] == Tile.colDirtLavaMountainUp)
			return Tile.dirtLavaMountainUp;
		return Tile.voidTile;
	}
