...
//	private int minusWidth = 0, porcCurrentHP = 100;
	...
	public void render(Screen screen) {
		...
		if (anim > 0 && anim < 90)
			screen.renderSprite((int) (x - 16), (int) (y - 16), earthApp1, true);
		if (anim > 90 && anim < 210)
			font.renderString(phrase, (int) getX() - 85, (int) getY() - 25, true, screen);
		else if (anim > 209 && anim < 330)
			font.renderString(phrase2, (int) getX() - 80, (int) getY() - 25, true, screen);
