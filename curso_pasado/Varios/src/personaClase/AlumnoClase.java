...
public class AlumnoClase extends PersonaClase {
	...
	public AlumnoClase(String nombre, String nif, Fecha fechaNacimiento, Integer numMatricula, Integer curso,
			String grupo, Integer[] notas) {
	...
	public String toString() { // Alumno
		return "AlumnoClase [numMatricula=" + super.toString() + numMatricula + ", curso=" + curso + ", grupo=" + grupo
