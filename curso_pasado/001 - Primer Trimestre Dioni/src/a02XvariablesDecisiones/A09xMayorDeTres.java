...
/**
 * 9. Escribe un programa que decida cual de tres números introducidos por teclado es el mayor
...
public class A09xMayorDeTres {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"El número más grande es: " + mayor + ", seguido de " + middle + ", y por último" + menor + ".");
		teclado.close();
	}
}
